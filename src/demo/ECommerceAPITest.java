...
public class ECommerceAPITest {
	...
	public static <OrderDetail> void main(String[] args) {
...
//step 1 :
				...
				.multiPart("productImage",new File("C:\\Users\\Admin\\Downloads\\LAPTOP.jpg"));
...
//				RequestSpecification createOrderReq = given().log().all().spec(createOrderBaseReq).body();
//
